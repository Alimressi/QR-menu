...
const categories: CategorySeed[] = [
  ...
  { nameEn: "Sour", nameRu: "Сауэр", nameAz: "Sour" },
  { nameEn: "Hot Alcohol", nameRu: "Горячий алкоголь", nameAz: "İsti alkoqol" },
  { nameEn: "Whiskey", nameRu: "Виски", nameAz: "Viski" },
  { nameEn: "Vodka", nameRu: "Водка", nameAz: "Vodka" },
  { nameEn: "Tequila", nameRu: "Текила", nameAz: "Tekila" },
  { nameEn: "Gin", nameRu: "Джин", nameAz: "Cin" },
  { nameEn: "Rum", nameRu: "Ром", nameAz: "Rom" },
  { nameEn: "Liqueurs", nameRu: "Ликеры", nameAz: "Likyorlar" },
  { nameEn: "Aperitive", nameRu: "Аперитивы", nameAz: "Aperitiflər" },
  { nameEn: "Beer", nameRu: "Пиво", nameAz: "Pivə" },
  { nameEn: "Shot Section", nameRu: "Шоты", nameAz: "Shot bölməsi" },
  { nameEn: "Lemonades", nameRu: "Лимонады", nameAz: "Limonadlar" },
  { nameEn: "Soft Drinks", nameRu: "Безалкогольные напитки", nameAz: "Alkoqolsuz içkilər" },
  { nameEn: "Coffee", nameRu: "Кофе", nameAz: "Kofe" },
  { nameEn: "Ice Coffee", nameRu: "Холодный кофе", nameAz: "Buzlu kofe" },
  ...
  { nameEn: "Local White Wine", nameRu: "Местное белое вино", nameAz: "Yerli ağ şərab" },
  { nameEn: "Local Rose Wine", nameRu: "Местное розовое вино", nameAz: "Yerli çəhrayı şərab" },
  { nameEn: "Wines", nameRu: "Вина", nameAz: "Şərablar" },
  { nameEn: "Classic Wines", nameRu: "Классические вина", nameAz: "Klassik şərablar" },
  { nameEn: "Sparkling Wines", nameRu: "Игристые вина", nameAz: "Şampan və köpüklü şərablar" },
];
